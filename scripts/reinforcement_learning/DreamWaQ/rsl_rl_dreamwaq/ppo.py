...
class PPO:
    ...
    def act(self, obs, critic_obs, prev_critic_obs, obs_history):
        ...
        self.transition.prev_privileged_observations = prev_critic_obs
    ...
    def update(self,beta=1):
        ...
        for obs_batch, critic_obs_batch, prev_critic_obs_batch, obs_hist_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, \
            old_mu_batch, old_sigma_batch, hid_states_batch, masks_batch in generator:
                ...
                # Note: prev_critic_obs_batch[:,45:48] assumes specific structure of privileged obs.
                # In IsaacLab, we need to ensure privileged obs has velocity at these indices or adjust.
                # For now, I'll keep it as is, but this is a potential point of failure if obs structure differs.
